# Alondra H., Sadie HS. -List Project pt 1
#1/10/24
shopList = []
...
def menu():
    ans = input("What would you like to do today? [Add] items to list, [View] current list, [Mark] a completed task, or [Exit] program?: ")
    if ans == "add" or "Add":
       addItem()
    if ans == "View" or "view":
         view()
